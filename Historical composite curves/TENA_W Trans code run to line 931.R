...
RPDent <-  dbGetQuery(mydb, "SELECT e.* FROM entity e 
                      WHERE ID_ENTITY in(1, 4, 5, 6, 7, 9, 1427, 13, 19, 21, 23, 25, 37, 38, 41, 42, 44, 48, 54, 55, 57, 58, 1429, 1441, 67, 68, 128, 129, 137, 138, 139, 141, 142, 143, 144, 145, 163, 192, 193, 194, 195, 196, 1465, 253, 254, 319, 321, 347, 361, 425, 427, 428, 429, 487, 544, 791, 792, 822, 823, 824, 839, 840, 841, 842, 845, 846, 850, 851, 852, 856, 1445, 1442, 1443, 937, 1423, 1784, 1788, 1789, 1790, 1792, 1793, 1794, 1795, 1796, 1797, 1798, 1802, 2025, 2062, 2063, 2064, 2065, 2067, 2098, 2157, 2232, 2255, 2256)
...
write.csv(RPDdat, "/Users/paullincoln/Dropbox/2021/September 2021/Composite code v2/TENA_Wdat.csv", row.names = F)
write.csv(RPDsite, "/Users/paullincoln/Dropbox/2021/September 2021/Composite code v2/TENA_Wsite.csv", row.names = F)
write.csv(RPDent, "/Users/paullincoln/Dropbox/2021/September 2021/Composite code v2/TENA_Went.csv", row.names = F)
write.csv(RPDchron, "/Users/paullincoln/Dropbox/2021/September 2021/Composite code v2/TENA_Wchron.csv", row.names = F)
...
ent <- read.csv('/Users/paullincoln/Dropbox/2021/September 2021/Composite code v2/TENA_Went.csv', na.strings = 'NULL')

dat <- read.csv('/Users/paullincoln/Dropbox/2021/September 2021/Composite code v2/TENA_Wdat.csv' , na.strings = 'NULL')

chron <- read.csv('/Users/paullincoln/Dropbox/2021/September 2021/Composite code v2/TENA_Wchron.csv' , na.strings = 'NULL')
...
dir.create("/Users/paullincoln/Dropbox/2021/September 2021/Composite code v2/Influx conversion/TENA_W")
csvpath <- "/Users/paullincoln/Dropbox/2021/September 2021/Composite code v2/Influx conversion/TENA_W/"
...
for (j in maxsites[75:92]) { ##trying looping using entity names: changed from j in 1:maxsites
   nsamp <- 0
  sitedata <- data_query[data_query$ID_ENTITY == j, ]
  ...
  if (nsamp > 1 && sum(influx) > 0) { ##Quality control bit after z score calculation: I changed nsamp from >0 to >1. 
   ...
   #delete any rows in this data that have zero and negative sed rate, and save them so you can see how many are removed.
    neg.infl <- append(neg.infl, outdata[outdata$sed_rate <= 0,])
    outdata <- outdata[!(outdata$sed_rate <= 0),]
    csvfile <- paste("/Users/paullincoln/Dropbox/2021/September 2021/Composite code v2/Influx conversion/TENA_W/",entid,"_RPD_", ".csv", sep="")
