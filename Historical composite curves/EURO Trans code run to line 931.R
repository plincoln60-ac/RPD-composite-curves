1639, 1644, 1645, 1647, 1649, 1651, 1652, 1653, 1655, 1658, 1659, 1660, 1661, 1669, 1670, 1671, 1675, 1676, 1678, 1679, 1680, 1681, 1682, 1686, 1689, 1690, 1691, 1694, 1697, 1699, 1701, 1703, 1704, 1705, 1707, 1708, 1713, 1718, 1723, 1724, 1725, 1729, 1732, 1733, 1747, 2466, 1753, 1754, 1762, 1863, 1882, 2075, 2083, 2092, 2100, 2101, 2105, 2125, 2130, 2132, 2133, 2147, 2166, 2169, 2170, 2172, 2173, 2174, 2175, 2176, 2177, 2181, 2185, 2188, 2189, 2190, 2191, 2194, 2200, 2202, 2203, 2218, 2240, 2241, 2244, 2246, 2247, 2248, 2249, 2251, 2252, 2254, 2260, 2261, 2262, 2263, 2264, 2265, 2266, 2267, 2268, 2269, 2270, 2271, 2272, 2273, 2274, 2275, 2276, 2277, 2278, 2279, 2280, 2281, 2288, 2290, 2291, 2292, 2293, 2294, 2295, 2296, 2381, 2382, 2383, 2384, 2385, 2386, 2420, 2422, 2427, 2436, 2440, 2443, 2446, 2447, 2448, 2449, 2450, 2455, 2456, 2458, 2462, 2464, 2465, 2477, 247);") 
...
write.csv(RPDdat, "/Users/paullincoln/Dropbox/2021/September 2021/Composite code v2/EUROdat.csv", row.names = F)
write.csv(RPDsite, "/Users/paullincoln/Dropbox/2021/September 2021/Composite code v2/EUROsite.csv", row.names = F)
write.csv(RPDent, "/Users/paullincoln/Dropbox/2021/September 2021/Composite code v2/EUROent.csv", row.names = F)
write.csv(RPDchron, "/Users/paullincoln/Dropbox/2021/September 2021/Composite code v2/EUROchron.csv", row.names = F)
...
ent <- read.csv('/Users/paullincoln/Dropbox/2021/September 2021/Composite code v2/EUROent.csv', na.strings = 'NULL')

dat <- read.csv('/Users/paullincoln/Dropbox/2021/September 2021/Composite code v2/EUROdat.csv' , na.strings = 'NULL')

chron <- read.csv('/Users/paullincoln/Dropbox/2021/September 2021/Composite code v2/EUROchron.csv' , na.strings = 'NULL')
...
#loop 1 ----
for (j in maxsites[88]) { ##trying looping using entity names: changed from j in 1:maxsites
   nsamp <- 0
...
dir.create("/Users/paullincoln/Dropbox/2021/September 2021/Composite code v2/Influx conversion/EURO")
csvpath <- "/Users/paullincoln/Dropbox/2021/September 2021/Composite code v2/Influx conversion/EURO/"
...
#INFLUX LOOP----
rm(j)
for (j in maxsites[224:225]) { ##trying looping using entity names: changed from j in 1:maxsites
   nsamp <- 0
  sitedata <- data_query[data_query$ID_ENTITY == j, ]
  ...
  if (nsamp > 1 && sum(influx) > 0) { ##Quality control bit after z score calculation: I changed nsamp from >0 to >1. 
   ...
   #delete any rows in this data that have zero and negative sed rate, and save them so you can see how many are removed.
    neg.infl <- append(neg.infl, outdata[outdata$sed_rate <= 0,])
    outdata <- outdata[!(outdata$sed_rate <= 0),]
    csvfile <- paste("/Users/paullincoln/Dropbox/2021/September 2021/Composite code v2/Influx conversion/EURO/",entid,"_RPD_", ".csv", sep="")
...
sitecsvpath <- paste("/Users/paullincoln/Dropbox/2021/September 2021/Composite code v2/Influx conversion/EURO/",sep="") #where all the csvs that have the influx data are stored.
sitecsvpath
transcsvpath <- paste("/Users/paullincoln/Dropbox/2021/September 2021/Composite code v2/ZTrans_EURO/",sep="") # 
transcsvpath
...
write.csv(ent_vec, "/Users/paullincoln/Dropbox/2021/September 2021/Composite code v2/Influx conversion/EURO/final_entities.csv")
